...
> \`nowplaying\`, \`queue\`, \`volume\``)
            .setFooter("GameArea MusicBot", "https://media.giphy.com/media/RIGxhiTB2VU9QDTuYW/giphy.gif");
    ...
    if (command === "search" || command === "sc") {
            ...
            try {
                ...
                try {
                    ...
                    let embedPlay = new MessageEmbed()
                        ...
                        .setFooter("Please choose one of the following 10 results, this embed will auto-deleted in 15 seconds", "https://media.giphy.com/media/RIGxhiTB2VU9QDTuYW/giphy.gif");
        ...
        if (!serverQueue) return message.channel.send("There is nothing playing that I could leave for you");
        serverQueue.songs = [];
        serverQueue.connection.dispatcher.end("[runCmd] Leave command has been used");
        ...
        let embedQueue = new MessageEmbed()
            ...
            .setFooter(`• Now Playing: ${serverQueue.songs[0].title}`, "https://media.giphy.com/media/RIGxhiTB2VU9QDTuYW/giphy.gif");
